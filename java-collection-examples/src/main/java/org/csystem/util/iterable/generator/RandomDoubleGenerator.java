...
public class RandomDoubleGenerator implements Iterable<Integer>{
    private final int m_count;
    private final IntSupplier m_supplier;


    private RandomDoubleGenerator(int count, IntSupplier intSupplier)
    {
        m_count = count;
        m_supplier = intSupplier;
    }

    public static RandomDoubleGenerator of(Random random, int count, int min, int max)
    {
        return of(count, () -> random.nextInt(max - min) + min);
    }

    public static RandomDoubleGenerator of(int count, IntSupplier intSupplier)
    {
        return new RandomDoubleGenerator(count, intSupplier);
    }
